...
def read_urls(filename):
  ...
  f = open(filename)
  #dir = 'C:\GitProjects\google-python\logpuzzle'   
...
def download_images(img_urls, dest_dir):
  ...
  for img_url in img_urls:
    ...
    with urllib.request.urlopen(img_url) as response, open(os.path.join(dest_dir, local_name), 'wb') as out_file:
